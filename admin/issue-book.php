...
function log1($message)
{
    ...
    flush();
    ob_flush();
} //checking purposes for variable values
...
$mail_temp="Select EmailId from tblstudents where StudentId = '$studentid'";
$query = $dbh->prepare($mail_temp);
$query->execute();
...
$headers = "From: manav.dev.server@gmail.com";
